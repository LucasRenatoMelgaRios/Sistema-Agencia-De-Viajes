...
export const EditarProductoForm = ({ showModal, closeModal, producto }) => {
  ...
  // Prellenar el formulario con los datos del producto seleccionado al abrir el modal
  useEffect(() => {
    if (producto) {
      setFormData({
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Form data (edited product):', formData);
