...
import { ModalComponent } from "../ModalComponent"; // Usar el componente genérico del modal
import styled from "styled-components";

export const LeerPoliticasDeUsoModalNotificaciones = ({ showModal, closeModal }) => {
  return (
    <ModalComponent showModal={showModal} closeModal={closeModal} titulo="Acuerdos de Uso Legal">
      <p>
