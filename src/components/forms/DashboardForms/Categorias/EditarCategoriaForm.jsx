...
export const EditarCategoriaForm = ({ showModal, closeModal, categoria }) => {
  ...
  // Prellenar el formulario con los datos de la categoría seleccionada al abrir el modal
  useEffect(() => {
    if (categoria) {
      setFormData({
        imagen: categoria.imagen || '',
        nombre: categoria.name || '',
        productos: categoria.piece || '',
        valorTotal: categoria.price || '',
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Form data (edited):', formData);
...
// Usamos los mismos estilos que en el formulario de "Agregar Categoría"
